...
The goal of this module is to demonstrate how custom microbiome reference databases are constructed through genome dereplication. In this module, participants will learn how dereplication is performed using MAGmax, and how to interpret the resulting set of species-level representative genomes.
...
The workflow for clustering genomes and selecting species-level representatives using MAGmax can be summarized as shown below. [![building_eference_microbiome_databases](https://github.com/WCSCourses/Human_Gut_Microbiome_Metagenomics_2026/raw/main/course_modules_2026/Module3_building_eference_microbiome_databases/images/magmax_workflow.png){alt="building_eference_microbiome_databases"}](https://github.com/WCSCourses/Human_Gut_Microbiome_Metagenomics_2026/blob/main/course_modules_2026/Module3_building_eference_microbiome_databases/images/magmax_workflow.png)
...
**Important references:** Arangasamy Yazhini, Johannes Söding, Enhancing genome recovery across metagenomic samples using MAGmax, Bioinformatics (2025), <https://doi.org/10.1093/bioinformatics/btaf538>.
